    ...
    fun buscar(view: View){
        ...
        service.getUser("/users/"+usuario).enqueue(object : Callback<UserResponse> {
            override fun onResponse(call: Call<UserResponse>, response: Response<UserResponse>) {
                ...
                val html_url = dadosRecebidos?.html_url
...
// Código alterado:
// foi acrescentado a classe UserResponse o html_url e company
// na saida do txtNome foi acrescentado "${nome}\n${company}\n${html_url}" estes dados.